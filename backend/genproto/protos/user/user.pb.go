...
const file_protos_user_user_proto_rawDesc = "" +
	"\n" +
	"\x16protos/user/user.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\"(\n" +
	"\x0eHealthResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2J\n" +
	"\vUserService\x12;\n" +
	"\vHealthCheck\x12\x16.google.protobuf.Empty\x1a\x14.user.HealthResponseB9Z7github.com/Acad600-TPA/WEB-MJ-242/backend/genproto/userb\x06proto3"
