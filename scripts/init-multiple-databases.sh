...
DB_MESSAGE_NAME="${POSTGRES_DB_MESSAGE:-ay_message_db}"
DB_COMMUNITY_NAME="${POSTGRES_DB_COMMUNITY:-ay_community_db}"
...
create_database_if_not_exists "$DB_MESSAGE_NAME"
create_database_if_not_exists "$DB_COMMUNITY_NAME"
